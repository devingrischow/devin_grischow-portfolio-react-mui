export const workExperience = [
...

    {
        ...
        workType:"Contract - Remote",
        points:[
            "Tested a variety of data entry, visualization, and image detection software before the program like Orange, and Apple AI Model creation tools.",
            "Aided in helping students grasp modern AI models types, their applications, use cases, and more.",
            "Students then took the knowledge and each built AI-powered apps to solve problems they thought AI would be helpful with."
        ]
    },

    {
        ...
        workType:"Contract - Remote",
        points:[
            "Tutored over 2 teams with 10 beginner developers, helping them learn to plan, design, create, and publish iOS apps, according to a client’s needs.",
            "Teams learned to take concepts and requests for features like trying to get insights into and connecting Chicago communities, and to successfully deliver apps and ideas according to those requirements."
        ]
    },
...

    {
        ...
        workType:"Contract - Remote",
        points:[
            "Provided teaching & tutoring assistance to 17 students to develop & publish 5 SwiftUI apps onto the iOS App Store. Students went from being new to development, to knowing what it takes to build fully modern and stable iOS apps.",
